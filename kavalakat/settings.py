...
# Required for Django 4.0+ — any POST from a non-localhost domain must be listed here.
# Without this, all dashboard form submissions return 403 CSRF verification failed.
CSRF_TRUSTED_ORIGINS = os.environ.get(
    'CSRF_TRUSTED_ORIGINS',
    'https://api.kavalakat.com,https://tan-rail-168119.hostingersite.com,http://localhost:8000,http://127.0.0.1:8000'
).split(',')
