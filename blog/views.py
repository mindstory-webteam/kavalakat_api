...
class PostViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        s = PostWriteSerializer(data=request.data, context={'request': request})
        s.is_valid(raise_exception=True)
        obj = s.save()
        return Response(
            {'success': True, 'message': 'Post created.', 'data': PostDetailSerializer(obj, context={'request': request}).data},
    ...
    def by_category(self, request, name=None):
        ...
        return Response({
            'success':  True,
            'category': BlogCategorySerializer(cat).data,
            'count':    qs.count(),
