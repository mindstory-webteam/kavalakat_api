...
class PostListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_featured', 'is_ai_generated', 'views',
...
class PostDetailSerializer(PostListSerializer):
    """
    Full detail serializer — includes content, meta, and bottom_html.
    Used for single post GET /api/blog/<slug>/
    """
    class Meta(PostListSerializer.Meta):
        fields = PostListSerializer.Meta.fields + [
            'content',
            'bottom_html',       # ← ADDED: returned to frontend
            'meta_title',
            'meta_description',
            'updated_at',
        ]
...
class PostWriteSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'category', 'author', 'status', 'tags',
            'is_featured', 'is_ai_generated',
            'bottom_html',       # ← ADDED: can be written via API
