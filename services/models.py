...
class ServiceCategory(models.Model):
    ...
    color       = models.CharField(max_length=20, blank=True, default='#0284f0', help_text='Hex color e.g. #f97316')
...
class ServiceCounter(models.Model):
    ...
    counter_number    = models.CharField(max_length=50, help_text='e.g. 4+, 100%, 24/7')
    ...
    def __str__(self):
        return f'{self.service.name} – {self.counter_number}'
...
class ServiceOffer(models.Model):
    ...
    offer_icon        = models.CharField(max_length=100, blank=True)
